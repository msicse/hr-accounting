...
@section('title','Admin | Housekeeping')
...
@section('contentBody')
	<div class="card">
        ...
        <div class="card-body card-padding">
			<form action="{{ action("HousekeepingController@store") }}" method="post">
			{{ csrf_field() }}
					...
					<tfoot>
						<tr >
							<td colspan="3" class="text-center">
								<button type="submit" class=" text-center btn btn-primary btn-sm center-block">Add Housekeeping</button>
							</td>
						</tr>
					...
					@foreach( $stationareies as $asset )
						...
						<tr>
							...
							<td class="text-center">
								<a href="{{ url('housekeeping', [$asset->id,'edit']) }}" class=""><i class="fa fa-pencil custom-font" aria-hidden="true"></i></a>
                            
                            <a href="{{ url('housekeeping',$asset->id) }}" data-method="delete" 
