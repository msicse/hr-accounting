...
@section('contentBody')
	<div class="card">
        ...
        <div class="card-body card-padding">
			<form action="{{ action("FixedAssetController@store") }}" method="post">
			{{ csrf_field() }}
					...
					<tfoot>
						<tr >
							<td colspan="3" class="text-center">
								<button type="submit" class=" text-center btn btn-primary btn-sm center-block">Add Asset</button>
							</td>
						</tr>
					...
					@foreach( $fixedassets as $asset )
						...
						<tr>
							...
							<td class="text-center">
								<a href="{{ url('fixed-assets', [$asset->id,'edit']) }}" class=""><i class="fa fa-pencil custom-font" aria-hidden="true"></i></a>
                            
                            <a href="{{ url('fixed-assets',$asset->id) }}" data-method="delete" 
