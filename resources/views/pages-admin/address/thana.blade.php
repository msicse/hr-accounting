...
<select class="Pabna" id="">

	<option value="" selected>Select a Thana</option>

	<option value="Banwarinagar">Banwarinagar</option>
	...
	<option value="Debottar">Debottar</option>

	<option value="Ishwardi">Ishwardi</option>

	<option value="Sadar">Pabna Sadar</option>

	<option value="Sathia">Sathia</option>
...
<select class="Rajshahi" id="">
	...
	<option value="Ghuramara">Ghuramara</option>

	<option value="Godagari">Godagari</option>

	<option value="Khod-Mohanpur">Khod Mohanpur</option>

	<option value="Lalitganj">Lalitganj</option>

	<option value="Putia">Putia</option>

	<option value="Sadar">Rajshahi Sadar</option>

	<option value="380">Rajshai Sadar</option>

	<option value="Tanor">Tanor</option>
...
<select class="Sirajganj" id="">

	<option value="" selected>Select a Thana</option>

	<option value="Baiddya-Jam-Toil">Baiddya Jam Toil</option>

	<option value="Belkuchi">Belkuchi</option>

	<option value="Dhangora">Dhangora</option>

	<option value="Kazipur">Kazipur</option>

	<option value="Shahjadpur">Shahjadpur</option>

	<option value="Sadar">Sirajganj Sadar</option>
