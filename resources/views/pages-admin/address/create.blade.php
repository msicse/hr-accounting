                                    ...
                                    <div class="fg-line">
                                        <div class="select">
                                            ...
                                            <select class="form-control" name="dist" id="dis" onchange="find_thana(this.value);" >
                                                ...
                                                <option value="Borguna" {{ Input::old('dist') == 'Borguna' ? 'selected' : '' }} >Borguna</option>
                                                ...
                                                <option value="Chapai-Nawabganj" {{ Input::old('dist') == 'Chapai-Nawabganj' ? 'selected' : '' }} >Chapai Nawabganj</option>
                                                ...
                                                <option value="Cox’s Bazar" {{ Input::old('dist') == 'Cox’s Bazar' ? 'selected' : '' }} >Cox’s Bazar</option>
                                                ...
                                                <option value="Gaibanda" {{ Input::old('dist') == 'Gaibanda' ? 'selected' : '' }} >Gaibanda</option>
                                                ...
                                                <option value="Jhalakathi" {{ Input::old('dist') == 'Jhalakathi' ? 'selected' : '' }} >Jhalakathi</option>
                                                ...
                                                <option value="Moulvi-Bazar" {{ Input::old('dist') == 'Moulvi-Bazar' ? 'selected' : '' }} >Moulvi-Bazar</option>
                                                ...
                                                <option value="Nilfamari" {{ Input::old('dist') == 'Nilfamari' ? 'selected' : '' }} >Nilfamari</option>
                                                ...
                                                <option value="Panchagar" {{ Input::old('dist') == 'Panchagar' ? 'selected' : '' }} >Panchagar</option>
                                    ...
                                    <div class="fg-line">
                                        <div class="select">
                                            ...
                                            <select class="form-control" name="per_dist">
                                                ...
                                                <option value="Borguna" {{ Input::old('per_dist') == 'Borguna' ? 'selected' : '' }} >Borguna</option>
                                                ...
                                                <option value="Chapai-Nawabganj" {{ Input::old('per_dist') == 'Chapai-Nawabganj' ? 'selected' : '' }} >Chapai Nawabganj</option>
                                                ...
                                                <option value="Cox’s Bazar" {{ Input::old('per_dist') == 'Cox’s Bazar' ? 'selected' : '' }} >Cox’s Bazar</option>
                                                ...
                                                <option value="Gaibanda" {{ Input::old('per_dist') == 'Gaibanda' ? 'selected' : '' }} >Gaibanda</option>
                                                <option value="Gopalganj" {{ Input::old('per_dist') == 'Gopalganj' ? 'selected' : '' }} >Gopalganj</option>
                                                <option value="Habiganj" {{ Input::old('per_dist') == 'Habiganj' ? 'selected' : '' }} >Habiganj</option>
                                                ...
                                                <option value="Jhalakathi" {{ Input::old('per_dist') == 'Jhalakathi' ? 'selected' : '' }} >Jhalakathi</option>
                                                ...
                                                <option value="Khargrachhari" {{ Input::old('per_dist') == 'Khargrachhari' ? 'selected' : '' }} >Khargrachhari</option>
                                                ...
                                                <option value="Moulvi-Bazar" {{ Input::old('per_dist') == 'Moulvi-Bazar' ? 'selected' : '' }} >Moulvi-Bazar</option>
                                                ...
                                                <option value="Nilfamari" {{ Input::old('per_dist') == 'Nilfamari' ? 'selected' : '' }} >Nilfamari</option>
                                                ...
                                                <option value="Panchagar" {{ Input::old('per_dist') == 'Panchagar' ? 'selected' : '' }} >Panchagar</option>
                                                ...
                                                <option value="Sunamgonj" {{ Input::old('per_dist') == 'Sunamgonj' ? 'selected' : '' }} >Sunamgonj</option>
                                    ...
                                    <div class="fg-line">
                                        <div class="select">
                                            ...
                                            <select class="form-control" name="em_dist">
                                                ...
                                                <option value="Borguna" {{ Input::old('em_dist') == 'Borguna' ? 'selected' : '' }} >Borguna</option>
                                                ...
                                                <option value="Chapai-Nawabganj" {{ Input::old('em_dist') == 'Chapai-Nawabganj' ? 'selected' : '' }} >Chapai Nawabganj</option>
                                                ...
                                                <option value="Cox’s Bazar" {{ Input::old('em_dist') == 'Cox’s Bazar' ? 'selected' : '' }} >Cox’s Bazar</option>
                                                ...
                                                <option value="Gaibanda" {{ Input::old('em_dist') == 'Gaibanda' ? 'selected' : '' }} >Gaibanda</option>
                                                <option value="Gopalganj" {{ Input::old('em_dist') == 'Gopalganj' ? 'selected' : '' }} >Gopalganj</option>
                                                <option value="Habiganj" {{ Input::old('em_dist') == 'Habiganj' ? 'selected' : '' }} >Habiganj</option>
                                                ...
                                                <option value="Jhalakathi" {{ Input::old('em_dist') == 'Jhalakathi' ? 'selected' : '' }} >Jhalakathi</option>
                                                ...
                                                <option value="Khargrachhari" {{ Input::old('em_dist') == 'Khargrachhari' ? 'selected' : '' }} >Khargrachhari</option>
                                                ...
                                                <option value="Moulvi-Bazar" {{ Input::old('em_dist') == 'Moulvi-Bazar' ? 'selected' : '' }} >Moulvi-Bazar</option>
                                                ...
                                                <option value="Nilfamari" {{ Input::old('em_dist') == 'Nilfamari' ? 'selected' : '' }} >Nilfamari</option>
                                                ...
                                                <option value="Panchagar" {{ Input::old('em_dist') == 'Panchagar' ? 'selected' : '' }} >Panchagar</option>
                                                ...
                                                <option value="Sunamgonj" {{ Input::old('em_dist') == 'Sunamgonj' ? 'selected' : '' }} >Sunamgonj</option>
