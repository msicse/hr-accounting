...
@section('contentBody')
  <div class="card">
        <div class="card-header">
            <h2>Add Off Day <a href="{{ url('offday/month') }}"> <span class="pull-right btn btn-primary custom-btn"><i class="fa fa-arrow-left" aria-hidden="true"></i> back </a>
</span> </h2> 
        </div>
        <div class="card-body card-padding">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center"> 
                <form role="form" method="post" action="{{ action("OffdayController@store") }}" class="remove-margin-p">
                    {{ csrf_field() }}
                    ...
                    <?php
                        ...
                        function generate_calendar($year, $month, $days = array(), $day_name_length = 3, $month_href = NULL, $first_day = 0, $pn = array()) {
                            ...
                            echo generate_calendar( $year, $month, 16, 3, NULL, 0, 15);
                    ...
                    <button type="button" class="btn btn-primary btn-sm m-t-10" onclick="submit_2();">Submit</button>
                </form>
            </div>
        </div>   
        </div>
...
@section('scripts')
    <script>
            ...
            function submit_2() {
				...
				var url = location.origin+'/offday';
