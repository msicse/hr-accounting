...
@section('title','Admin | Stationaery Edit')
...
@section('contentBody')
	<div class="card">
        ...
        <div class="card-body card-padding">
			<form action="{{ url('stationaery',$fixedasset->id) }}" method="post">
					...
					<tfoot>
						<tr >
							<td colspan="3" class="text-center">
								<button type="submit" class=" text-center btn btn-primary btn-sm center-block">Update Asset</button>
							</td>
						</tr>
