...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-6  menue-inline">
             <a href="#">Home</a>  / <a href="#">Purchase History</a> / <a href="#">Purchase Invoice </a>
        </div>
    </div>
    ...
    <div id="print-invoice" class="">
        <div class="row border-bottom">
            ...
            <div class="col-md-6 text-right">
                <h4> Purchase Code : {{ $invoice->purchase_code }} </h4> 
   ...
   {{--<a href="{{ route('purchase.print',[$invoice->id]) }}" class="btn btn-primary">Print</a>--}}
...
<script type="text/javascript">
      ...
      //function divPrint() {
        ...
        // $("#print-invoice").addClass("printable");
        // window.print();
