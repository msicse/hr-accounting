...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-10">
            <button class="btn btn-primary  p-10" data-toggle="modal" data-target="#customerAdd">Add Customer</button>
        </div>
    </div>
   ...
   <table id="example" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('customers.show',['id' => $contact->id ]) }}" class="btn btn-icon command-edit waves-effect waves-circle">
...
<div class="modal fade" id="customerAdd" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" method="POST" action="{{ route('customers.store') }}" class="remove-margin-p" >
                {{ csrf_field() }}
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $( ".edit_customer" ).click(function() {
                    ...
                    var update_url=location.origin+'/customers/'+account_id;

                    var url=location.origin+'/customers/'+account_id+'/edit';
                ...
                $( ".delete_customer" ).click(function() {
                    ...
                    var url=location.origin+'/customers/'+account_id;
