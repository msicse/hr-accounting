...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-10">
            <button class="btn btn-primary  p-10" data-toggle="modal" data-target="#categoryAdd">Add Category</button>
        </div>
    </div>
...
<div class="modal fade" id="categoryAdd" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" method="POST" action="{{ route('categories.store') }}" class="remove-margin-p">
                {{ csrf_field() }}
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group ">
                                <div class="fg-line">
                                    <label for="title">Category Name</label>
                                    <input type="text" class="form-control input-sm" id="edit-cat-name" name="name" placeholder="name" value="" />
                                </div>
                                    @if ($errors->has('title'))
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $( ".delete_category" ).click(function() {
                    ...
                    var url=location.origin+'/categories/'+account_id;
                ...
                $( ".edit_category" ).click(function() {
                    ...
                    var update_url=location.origin+'/categories/'+account_id;

                    var url=location.origin+'/categories/'+account_id+'/edit';

                    $('.edit_category_form').attr('action',update_url);
                            
                        $.get(url,function(data){
                            $('#edit-cat-name').val(data['cat_name']);
