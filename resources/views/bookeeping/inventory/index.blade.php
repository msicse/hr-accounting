...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-10">
            <button class="btn btn-primary  p-10" data-toggle="modal" data-target="#productAdd">Add Product</button>
        </div>
    </div>
...
<div class="modal fade" id="productAdd" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" method="POST" action="{{ route('products.store') }}" class="remove-margin-p" >
                {{ csrf_field() }}
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $( ".edit_product" ).click(function() {
                    ...
                    var update_url=location.origin+'/products/'+account_id;

                    var url=location.origin+'/products/'+account_id+'/edit';
                ...
                $( ".delete_product" ).click(function() {
                    ...
                    var url=location.origin+'/products/'+account_id;
