                        ...
                        <div class="panel-body table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input required name="discount" type="number" value="0" class="form-control" id="discount" onkeyup="calculate_grand_total()" onclick="calculate_grand_total()" ><i></i>
                                    </td>
                                </tr>
								<tr>
                                    <th>VAT</th>
                                    <td>
                                        <select name="vat_id" id="vat" class="form-control" onchange="calculate_grand_total()" onclick="calculate_grand_total()" >
