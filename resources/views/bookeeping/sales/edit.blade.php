        ...
        <form action="{{route('sales.update',[$invoice->id])}}" method="post">
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <th>Sale Code</th>
                                    <td><input type="text" class="form-control" name="purchase_code" readonly value="{{ $invoice->sale_code }}" /></td>
                                </tr>
                                <tr>
                                    <th>Customer <sup class="fa fa-star text-danger text-right" style="font-size: 12px;" aria-hidden="true"></sup></th>
                                    <td>
                                        <select name="supplier_id" id="" class="form-control">
                                            <option value="{{ $invoice->customer_id }}">{{ $invoice->first_name }}</option>
                                        ...
                                        <div class="input-group form-group">
                                            <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                                <div class="dtp-container">
                                                    <input type='text' class="form-control date-picker" placeholder="Click here..." id="due_date" name="due_date"
                ...
                <div class="col-md-4 col-md-offset-4">
                    <button type="submit" class="btn  btn-primary btn-block">Update Sale</button>
                </div>
            </div>
        </form>
    </div>
...
function addRow(tableID,id) {
        ...
        var url=location.origin+'/sales/'+id;
    ...
    function calculate_grand_total()
    {
        ...
        var url=location.origin+'/sales/'+sub_total+'/'+vat_id+'/'+discount;
