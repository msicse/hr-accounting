...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-10">
            <a href=" {{ route('incomes.create') }} " class="btn btn-primary  p-10" data-toggle="modal" >Add New Income</a>
        </div>
    </div>
    ...
    <table id="example" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th data-column-id="account">Acount</th>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group ">
                                <div class="fg-line">
                                    ...
                                    <input type="text" class="form-control input-sm" id="date" name="title" placeholder="title" value="" readonly />
                                </div>
                                    @if ($errors->has('title'))
                                        <p class="text-right text-danger">{{$errors->first('title')}}</p>
                                    @endif
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $( ".edit_product" ).click(function() {
                    ...
                    var update_url=location.origin+'/incomes/'+account_id;

                    var url=location.origin+'/incomes/'+account_id+'/edit';
                ...
                $( ".delete_product" ).click(function() {
                    ...
                    var url=location.origin+'/incomes/'+account_id;
