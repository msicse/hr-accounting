...
<div class="modal fade" id="categoryAdd" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" method="POST" action="{{ route('in-ex-categories.store') }}" class="remove-margin-p">
                {{ csrf_field() }}
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $( ".delete_category" ).click(function() {
                    ...
                    var url=location.origin+'/in-ex-categories/'+account_id;
