...
<div class="card">
                        ...
                        <table id="example" class="display" cellspacing="0" width="100%">
                            ...
                            <?php $i++ ; ?>
                                ...
                                <td>
                                    <a type="button" data-toggle="modal" data-edit-account-id="{{ $account->id }}" data-target="#accountEdit" class="btn btn-icon command-edit waves-effect waves-circle edit_account">
                                        <span class="zmdi zmdi-edit"></span>
                                    </a>
                                    <a class="btn btn-icon command-edit waves-effect waves-circle text-danger  delete_account"  data-toggle="modal" data-target="#accountDelete" data-account-id="{{ $account->id }}">
