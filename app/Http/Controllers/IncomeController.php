...
class IncomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $incomes = DB::table('incomes')
            ->join('income_expense_category', 'incomes.income_category_id', '=', 'income_expense_category.id')
            ->join('accounts', 'incomes.account_id', '=', 'accounts.id')
            ->select('incomes.*', 'income_expense_category.income_name as category_id ', 'accounts.title as account_id')
            ->get();

        $categories = Category::all();
        $accounts = Account::all();
        return view('bookeeping.income-expenses.incomes')->withIncomes($incomes)->withCategories($categories)->withAccounts($accounts);
    }
    ...
    public function create()
    {
        $categories = Category::all();
        $accounts = Account::all();
        return view('bookeeping.income-expenses.income.create')->withCategories($categories)->withAccounts($accounts);
    }
